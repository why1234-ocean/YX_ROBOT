...
```bash
# Option 1: HTTPS
git clone https://github.com/why1234-ocean/YX_ROBOT.git

# Option 2: SSH
git clone git@github.com:why1234-ocean/YX_ROBOT.git
```
...
python legged_lab/scripts/ssim_lab_YX_add_camera.py YX1.yaml
