...
if __name__ == "__main__":
    ...
    with open(f"/home/ocean/下载/LeggedLab-main/legged_lab/deploy/deploy_mujoco/configs/{config_file}", "r") as f:
        config = yaml.load(f, Loader=yaml.FullLoader)

        policy_path = "/home/ocean/下载/YX_robot_open/logs/YX1_flat/2026-03-21_23-01-03/exported/policy.pt"

        xml_path = "/home/ocean/下载/YX_robot_open/legged_lab/resources/YX1/scene_YX.xml"
