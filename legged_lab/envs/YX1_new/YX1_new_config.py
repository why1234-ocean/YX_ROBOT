...
from legged_lab.assets.YX_1 import YX_new_CFG
...
@configclass
class YX_new_RewardCfg(RewardCfg):
...
@configclass
class YX_new_FlatEnvCfg(BaseEnvCfg):

    reward = YX_new_RewardCfg()

    def __post_init__(self):
        super().__post_init__()
        self.scene.height_scanner.prim_body_name = "base_link"
        self.scene.robot = YX_new_CFG
...
@configclass
class YX_new_FlatAgentCfg(BaseAgentCfg):
    experiment_name: str = "YX_new_flat"
    wandb_project: str = "YX1_new_flat"


@configclass
class YX_new_RoughEnvCfg(YX_new_FlatEnvCfg):
...
@configclass
class YX_new_RoughAgentCfg(BaseAgentCfg):
    experiment_name: str = "YX_new_rough"
    wandb_project: str = "YX_new_rough"
